...
startlist <- read_html("https://www.procyclingstats.com/race/tour-de-france/2022/gc/startlist/alphabetical-with-filters") %>% 
  html_node("table") %>% 
  html_table() %>% 
  as_tibble(.name_repair = "unique") %>% 
  select(Ridername, Team)
...
Teams_long <- Teams %>% 
  ...
  pivot_longer(names_to = "Team",
               values_to = "Rider",
               cols = 1:6) %>% 
  mutate(BIB = c(1, 11, 18, 16, 22, 41, 81, 21, 171, 31, 97, 141, 198, 82, 111, 71, 61, 91, 172, 194, 24, 84, 142, 201, 105, 204, 161, 181, 101, 51, 8, 25, 28, 131, 151, 14))
...
These will appear once the first stage is complete
